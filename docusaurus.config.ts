...
const config: Config = {
  ...
  url: "https://documentation.dryeyenet.com",
  ...
  projectName: "dryeyenet-manual", // Usually your repo name.
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} DryEyeNet, by SmartDryEyes GmbH.`,
    },
    prism: {
